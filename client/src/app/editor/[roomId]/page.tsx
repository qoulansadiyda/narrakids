...
export default function EditorPage() {
  ...
  useEffect(() => {
    ...
    const compute = () => {
      ...
      const spreadRequiredWidth = pageSize.w * 2 + SPREAD_GAP;
      const scale = Math.min(1, maxW / spreadRequiredWidth);
    ...
    <main className="w-full min-h-screen bg-sky-50 font-nunito flex flex-col relative overflow-hidden">
      ...
      <div className="flex flex-1 w-full max-w-[1600px] mx-auto z-10 relative overflow-hidden bg-sky-50" style={{ height: "calc(100vh - 84px)" }}>
        ...
        <div className="flex-1 flex flex-col min-w-0 h-full p-4 md:p-6 overflow-y-auto custom-scrollbar relative">
          ...
          <div className="mt-8 flex flex-col xl:flex-row gap-6 items-stretch">
            <div className="flex-1 min-w-0 bg-white border-4 border-slate-100 rounded-3xl p-6 shadow-sm">
            ...
            {/* LEADERBOARD PANEL */}
            <div className="w-full xl:w-[400px] shrink-0 bg-white border-4 border-slate-100 rounded-3xl p-6 shadow-sm flex flex-col">
              <div className="text-sm font-black mb-4 text-yellow-500 uppercase tracking-widest flex items-center gap-2">
